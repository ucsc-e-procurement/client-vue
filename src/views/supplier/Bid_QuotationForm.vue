<template>
    <v-container class="elevation-1">
        <v-row no-gutters>
        <h5 class="headline">Quotation Submission Form</h5>
        </v-row>
        ...
        <v-row no-gutters class="mt-2 caption">
            No : {{ this.procurement.procurement_id }}
        </v-row>
        <v-row no-gutters class="mt-2 caption">
            To : Chairman, Procurement Committee, University of Colombo School of Computing
        </v-row>
        <v-row no-gutters class="mt-2 caption">
            We, the undersigned, declare that:<br>
            (a) We have examined and have no reservations to the Bidding Documents, including Addenda No.:<br>
            ...
            (f) If our quotation is accepted, we commit to obtain a performance security in accordance with ITV Clause 22<br>
            (h) Our firm, its affiliates or subsidiaries—including any subcontractors or suppliers for any part of the
            contract—has not been declared blacklisted by the National Procurement Agency;<br>
            (k) We understand that this quotation, together with your written acceptance thereof included in your
            notification of award, shall constitute a binding contract between us, until a formal contract is prepared and
            executed.<br>
            (l) We understand that you are not bound to accept the lowest evaluated quotation or any other quotation
            that you may receive.<br>
        </v-row>
        <v-row no-gutters class="mt-4 caption">
            Signed:
        </v-row>
