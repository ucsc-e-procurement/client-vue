        ...
        <v-dialog  v-if="dialog"  v-model="dialog" width="1200px">
         <v-card class="scroll">                
            ...
            <v-card-text>
                ...
                <p>This is reference to the above quotation number dated [DATE]. We wish to inform you that your quotation has been approved.  Please supply the under mentioned items to the University of Colombo School of Computing on or before [DELIVERY DATE]  together with the original invoice.</p>	
            </v-card-text>
            <br/>					          
            <!-- <v-data-table
