    ...
    getProcurements() {
      this.$http
        ...
        .then(response => {
          ...
          this.ongoingProcurementCount = response.data.filter(
            item => item.status == "on-going"
          ).length;
          this.completedProcurementCount = response.data.filter(
            item => item.status == "completed"
          ).length;
          this.terminatedProcurementCount = response.data.filter(
