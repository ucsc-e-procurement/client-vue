    ...
    <v-card class="mx-auto" max-width=1500>
        ...
        <v-form>    
            <v-row>
                ...
                <v-col cols="12" sm="6">
                <v-text-field
                    :value="new Date(this.$route.query.requisition.date).getDate() + ' - ' + new Date(this.$route.query.requisition.date).getMonth() + ' - ' + new Date(this.$route.query.requisition.date).getFullYear()"
            ...
            <v-row>
                ...
                <v-col cols="12" sm="6">
                <v-text-field
                    :value="this.$route.query.requisition.deputy_bursar_recommendation"
            ...
            <v-row>
                <v-col cols="12" sm="12">
                <ValidationProvider v-slot="{ errors }" name="Director Remarks" rules="required">
                <v-text-field
                ...
                <v-col cols="12" sm="6">
                <ValidationProvider v-slot="{ errors }" name="Director Approval" rules="required">
                    <v-select
        ...
        <v-row justify="center">
            ...
            <v-card>
                <v-card-title>
                    ...
                    <v-btn color="blue darken-1" text @click="acceptRequisition">Confirm</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
        </v-row>    
    ...
    acceptRequisition(){
        this.$http
            .post(`/api/director/requisitions/approve`,{
                ...
                directorRecommendation: this.directorApproval == 'Approve' ? 'Approved' : 'Denied'
            })
            .then(response => {
