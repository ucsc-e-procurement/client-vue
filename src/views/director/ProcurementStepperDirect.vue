              ...
              <v-col cols="12">
                <v-stepper v-model="stepperValue" vertical>
                  ...
                  <v-stepper-step
                    ...
                    >Technical Specification</v-stepper-step
                  >
                  ...
                  <v-stepper-step
                    ...
                    >Head Of Department Recommendation</v-stepper-step
                  >
                  ...
                  <v-stepper-step
                    ...
                    >Deputy Bursar Recommendation</v-stepper-step
                  >
                  ...
                  <v-stepper-step
                    :complete="procurementState > 9"
                    :editable="procurementState > 9 ? true : false"
                    step="9"
                    :edit-icon="procurementState > 9 ? '$complete' : '$edit'"
                    :complete-icon="procurementState > 9 ? '$edit' : '$edit'"
                  ...
                  <v-stepper-step
                    :complete="procurementState > 10"
                    :editable="procurementState > 10 ? true : false"
                    step="10"
                    :edit-icon="procurementState > 10 ? '$complete' : '$edit'"
                    :complete-icon="procurementState > 10 ? '$edit' : '$edit'"
                    >Purchase Order</v-stepper-step
                  >
                  ...
                  <v-stepper-step
                    :complete="procurementState > 11"
                    :editable="procurementState > 11 ? true : false"
                    step="11"
                    :edit-icon="procurementState > 11 ? '$complete' : '$edit'"
                    :complete-icon="procurementState > 11 ? '$edit' : '$edit'"
                    >Product Acquisition</v-stepper-step
                  >
